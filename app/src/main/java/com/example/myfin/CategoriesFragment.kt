...
class CategoriesFragment : Fragment() {
    ...
    private fun showAddOrEditCategoryDialog(existingCategory: Category?) {
        ...
        val colors = listOf(
            ...
            // Новые цвета
            "#F25F5C", // кораллово-красный
            "#FFE066", // ярко-жёлтый
            "#247BA0", // глубокий синий
            "#70C1B3", // мятный
            "#F4D03F", // золотистый
            "#E67E22", // оранжевый
            "#2ECC71", // изумрудный
            ...
            "#64FFDA", // аквамарин
            "#FFAB40", // персиковый
            "#B2FF59", // неоново-зелёный
            "#FF5252",  // красный
            "#FFB3BA", // пастельно-розовый
            "#B5EAD7", // пастельно-зелёный
            "#C7CEEA", // пастельно-синий
            "#FFDAC1", // пастельно-персиковый
            "#E2F0CB", // пастельно-лаймовый
            "#FF9AA2", // лососевый
            "#FFB7B2", // кораллово-розовый
            "#E2F0CB", // мятный
            "#B5EAD7", // мята
            "#C7CEEA"  // лавандовый
        )
